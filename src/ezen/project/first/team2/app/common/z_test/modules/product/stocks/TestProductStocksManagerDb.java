package ezen.project.first.team2.app.common.z_test.modules.product.stocks;
...
public class TestProductStocksManagerDb {
	...
	public static void main(String[] args) {
		...
		try {
			...
			try {
				...
				if (DO_INSERT_QUERY) {
					printTitle("레코드 추가");
					int id = mngr.getNextIdFromDb("prod_stock_id");
					var item = new ProductStockItem(id, 10, 100);
				...
				if (DO_UPDATE_QUERY) {
					...
					var _where = String.format("prod_stock_id=%d", item.getId());
